/**
 * @file tables.cpp
 * @brief Implementation of attack table generation
 * 
 * Implements magic bitboard attack generation for sliding pieces
 * and initializes all lookup tables required for move generation.
 */
...
// Precomputed white pawn attack bitboards for each square
...
// Precomputed black pawn attack bitboards for each square
...
// Reverses a bitboard (for sliding attack calculation)
...
// Calculates sliding attacks using Hyperbola Quintessence Algorithm
...
// Returns rook attacks for initialization (non-magic)
...
// Magic bitboard tables for rooks
Bitboard ROOK_ATTACK_MASKS[64];
int ROOK_ATTACK_SHIFTS[64];
Bitboard ROOK_ATTACKS[64][4096];

// Precomputed magic numbers for rook attack hashing
...
// Initializes magic lookup table for rooks
...
// Returns rook attacks using magic bitboard lookup
...
// Returns x-ray attacks for a rook (squares visible through blockers)
...
// Returns bishop attacks for initialization (non-magic)
...
// Magic bitboard tables for bishops
Bitboard BISHOP_ATTACK_MASKS[64];
int BISHOP_ATTACK_SHIFTS[64];
Bitboard BISHOP_ATTACKS[64][512];

// Precomputed magic numbers for bishop attack hashing
...
// Initializes magic lookup table for bishops
...
// Returns bishop attacks using magic bitboard lookup
...
// Returns x-ray attacks for a bishop (squares visible through blockers)
...
// Initializes the lookup table for squares between two aligned squares
...
// Lookup table for all squares on the line connecting two squares
Bitboard LINE[64][64];

// Initializes the lookup table for aligned squares
...
// Pawn attacks lookup table
Bitboard PAWN_ATTACKS[NCOLORS][NSQUARES];

// Pseudo-legal attacks for each piece type
Bitboard PSEUDO_LEGAL_ATTACKS[NPIECE_TYPES][NSQUARES];

// Initializes pseudo-legal attack tables for all piece types
...
// Initializes all attack lookup tables
