/**
 * @file position.cpp
 * @brief Implementation of position-related functions
 * 
 * Contains implementations for FEN parsing, position display,
 * Zobrist hashing, and piece movement.
 */
...
// Initializes Zobrist keys with pseudorandom values
...
// Pretty-prints the position with board, FEN, and hash
...
// Moves a piece, handling captures
